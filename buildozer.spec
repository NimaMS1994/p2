...
source.include_exts = py,png,jpg,kv,atlas,h5,TTF
...
requirements = python3==3.10,kivy==2.2.1,tensorflow==2.1.0,arabic_reshaper==3.0.0,python-bidi==0.4.2,keras==2.3.1
